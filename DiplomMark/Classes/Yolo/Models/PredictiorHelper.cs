...
{
    public class PredictiorHelper
         : PredictorBase, IPredictor
    {
        public static IPredictor Create(string modelPath, string[]? labels = null, bool useCuda = false)
        {
            return new PredictiorHelper(modelPath, labels, useCuda);
        }

        public PredictiorHelper(string modelPath, string[]? labels = null, bool useCuda = false)
